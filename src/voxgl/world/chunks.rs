...
pub const MAX_DATA_LOAD_QUEUE: usize = 8;
pub const MAX_MESH_LOAD_QUEUE: usize = 4;
pub const MAX_DATA_UNLOAD_QUEUE: usize = 8;
pub const MAX_MESH_UNLOAD_QUEUE: usize = 4;
